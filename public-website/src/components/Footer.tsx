  ...
  return (
    <footer className="bg-gray-900 text-white relative">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={scrollToTop}
        className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 z-10"
      >
      ...
      <div className="container-custom pt-16 pb-8">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-bold">NZ Mart</span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              NZ Mart - Sri Lanka's premier online retail destination, bringing you quality products 
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span>123 Galle Road, Colombo</span>
              </div>
            </div>
          </motion.div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            >
              <p>&copy; 2024 NZ Mart. All rights reserved.</p>
              <p className="text-sm mt-1">Made with ❤️ in Sri Lanka</p>
            </motion.div>
